...
@section('content')
<form action="{{ route('report.update', $asset->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('patch')
<div class="card">
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <x-adminlte-input-file-krajee name="fileUpload" id="fileUpload" label="File Upload" :config="$config" multiple
                accept="application/pdf,image/*" />

                <div class="row btn-group">
                    <x-adminlte-button class="btn" type="submit" label="Submit" theme="success" icon="fas fa-lg fa-save"/>
                    <a href="{{route('report.index')}}" class="btn btn-danger"><i class="fas fa-lg fa-times"></i> Cancel</a>
                </div>
            </div>
        </div>
</form>
