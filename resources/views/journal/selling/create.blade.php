        ...
        <div class="card-body">
            <form action="{{ route('selling.store') }}" method="POST">
                ...
                <div class="row">
                  ...
                  <x-adminlte-input name="sell_transdate" label="Tgl. Transaksi" label-class="must-fill" igroup-size="md" fgroup-class="col-md-6" error-key="sell_transdate" type="date" />
                </div>
                <div class="row">
            ...
            $.ajax({
              ...
              success: function (res) {
                ...
                if (res.result.inv_company != company) {
                  ...
                  let tr = 
                    `<tr class="${res.result.id}" id="${res.result.id}">
                      ...
                      <td>
                        <div class="form-group">
                          <div class="input-group">
                            <input class="form-control" id="hidden_sell_price" name="hidden_sell_price[]" type="hidden" />
                            <input class="form-control" value="" name="dtl_asset_sell_price[]" id="dtl_asset_sell_price" />
                          </div>
                        </div>
                      </td>
                      <td>
                  ...
                  const sellPrice = new AutoNumeric('#dtl_asset_sell_price', 0, {
                      currencySymbol: 'Rp. ',
                      allowDecimalPadding: 'floats',
                      modifyValueOnWheel: false
                  });

                  $('#dtl_asset_sell_price').on('change', function () {
                    $('#hidden_sell_price').val(sellPrice.getNumber());
                  })
