...
return [
    ...
    */
    ...
    'logo' => '<b>RG</b> ASSET',
    'logo_img' => 'assets/img/RGLogo_large.png',
    ...
    */
    ...
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-dark-success elevation-4 bg-primary',
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/datatables/css/dataTables.1.10.19.bootstrap4.min.css',
                ],
            ],
        ],
        'Select2' => [
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    ...
                    'location' => 'vendor/sweetalert2/js/sweetalert2.all.min.js',
                ],
            ],
        ],
        'Pace' => [
        ...
        'ApexCharts' => [
          ...
          'files' => [
            ...
            [
              'type' => 'css',
              'asset' => true,
              'location' => 'vendor/apexcharts/dist/apexcharts.css',
            ],
          ],
        ],
    ],
